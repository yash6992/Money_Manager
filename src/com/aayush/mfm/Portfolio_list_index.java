...
public class Portfolio_list_index extends ListActivity implements OnClickListener {
    ...
    class Load extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progDailog = new ProgressDialog(Portfolio_list_index.this);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i=new Intent(Portfolio_list_index.this,Ticker_Info.class);
   ...
   private void debt_pf() {
		...
		//sco.show();
		Intent debt_pf = new Intent(Portfolio_list_index.this, Portfolio_list_debt.class);
    ...
    private void equity_pf() {
		//Toast sco= Toast.makeText(getApplicationContext(), "scores",Toast.LENGTH_LONG);
		//sco.show();
		Intent equity_pf = new Intent(Portfolio_list_index.this, Portfolio_list_equity.class);
    ...
    private void index_pf() {
		//Toast sco= Toast.makeText(getApplicationContext(), "scores",Toast.LENGTH_LONG);
		//sco.show();
		Intent index_pf = new Intent(Portfolio_list_index.this, Portfolio_list_index.class);
