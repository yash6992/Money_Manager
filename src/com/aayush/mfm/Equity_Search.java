...
public class Equity_Search extends ListActivity{
	public String data;
	...
	protected String doInBackground(String... key) {
		...
		runOnUiThread(new Runnable(){
			public void run(){
				...
				SimpleAdapter adapter = new SimpleAdapter(Equity_Search.this,list,R.layout.item,new String[] {"ticker"},new int[] {R.id.tv});
...
protected void onListItemClick(ListView l, View v,int position,long id){
	...
	Intent i=new Intent(Equity_Search.this,Ticker_Info.class);
	
	i.putExtra("scrip",(ticker_c.substring(ticker_c.indexOf(":")+1)).trim() );
	startActivity(i);
