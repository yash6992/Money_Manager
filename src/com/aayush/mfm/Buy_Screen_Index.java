...
public class Buy_Screen_Index extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		 Toast.makeText(getApplicationContext(), "INDEX SCREEN", Toast.LENGTH_SHORT).show();
		...
		query.findInBackground(new FindCallback() {
		  public void done(List<ParseObject> objects, ParseException e) {
		    if (e == null) {
				...
				Tticker.setText(scrip.replace("%5E", ""));
                                                  ...
                                                  public void onStopTrackingTouch(SeekBar seekBar)
  {
	...
	public void save(String scrip,String quantity,String buy_price, String user){
		ParseObject portfolio =new ParseObject("Index");
