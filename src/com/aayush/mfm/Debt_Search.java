...
public class Debt_Search extends ListActivity implements OnClickListener {
 ...
 */ArrayList<HashMap<String,String>> list = new ArrayList<HashMap<String,String>>();
	...
	class Load extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progDailog = new ProgressDialog(Debt_Search.this);
    ...
    private void populateList(ArrayList<String> cat) {
    	for(String s: cat){
    	HashMap<String,String> tempts1 = new HashMap<String,String>();
    	tempts1.put("cat_type",s);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		String mf_type=temp1.get("cat_type");
		//Toast.makeText(this, mf_type, Toast.LENGTH_SHORT).show();
		Intent ta = new Intent(this, MF_Cat.class);
		ta.putExtra("cat_type",mf_type);
